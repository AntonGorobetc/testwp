...
function testwp_scripts() {
	wp_enqueue_style( 'testwp-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'testwp-style', 'rtl', 'replace' );

	wp_enqueue_script( 'testwp-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
...
wp_register_style("custom_style", get_template_directory_uri() . "/css/style.css", '', '1.0.0');
wp_enqueue_style('custom_style');

wp_register_script("custom_script", get_template_directory_uri() . "/js/custom.js", '', '1.0.0');
